...
// Tat: uGUI trong du an nay la DLL player build nen UIBehaviour khong co Reset()
// (Reset() cua uGUI nam trong #if UNITY_EDITOR, bi cat khi build player).
// Day chi la tien ich tu gan action mac dinh khi them component tu Inspector.
#if UNITY_EDITOR && AWAKEN_UGUI_IS_PACKAGE
        /// <inheritdoc/>
